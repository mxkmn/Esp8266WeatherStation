// HTML-страница, разделённая на 3 части для удобства добавления в неё данных
...
const char settingsPage2[] PROGMEM = R"=====(
  ...
  <body>
    ...
    <form action='/senddata' method='post' onsubmit='alert("Сейчас произойдёт применение настроек и перезагрузка метеостанции...");' id="filters">
      <div class='formFields'>
        ...
        <select name='hours'>
          ...
          <option value='0'>На текущий час</option>
    ...
    <article>
      ...
      <p>Основное логирование - вывод полученной информации в Serial.</p>
      <p>Логирование статуса WiFI - вывод информации об изменениях статуса WiFi в Serial.</p>
